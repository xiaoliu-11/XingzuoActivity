...
public class ImgElevenActivity extends AppCompatActivity {
    ...
    private String Path="http://81.68.179.52:8080/master/images/tianxiezuo.jpg";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_img_eleven);
        image1 = findViewById(R.id.iamge_bizhieleven);
        image1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DonwloadSaveImg.donwloadImg(ImgElevenActivity.this,Path);
