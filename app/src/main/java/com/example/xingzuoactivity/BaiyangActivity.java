...
public class BaiyangActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //button_http= (Button) findViewById (R.id.btn__baiyang_1) ;
    ...
    public  void  btn_BaiyangWeeksStart(View v){
...
//            tv_qq2.setText(analysis);
            ...
            tv5.setText(number);
            tv6.setText(summary);
            ToastUtil.ShowMsg(BaiyangActivity.this,"查询成功");
